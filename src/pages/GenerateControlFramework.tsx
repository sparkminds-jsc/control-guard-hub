...
export default function GenerateControlFramework() {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch(`https://abilene.sparkminds.net/webhook/6812a814-9d51-43e1-aff8-46bd1b01d4de?websiteUrl=${encodeURIComponent(formData.websiteUrl)}&companyName=${encodeURIComponent(formData.companyName)}`);
